...
class MusicPlayer extends Component {
  ...
  static defaultProps = {
    autoplay: false,
    progressColor: '#1a7aff',
    btnColor: 'rgba(51, 34, 51, 0.4)',
    playlist: [],
    style: {},
  }
      ...
      <div>
        <div className="player-container" style={this.props.style}>
          ...
          <div className="info-and-control">
            ...
            <div className="progress-container" onClick={this.handleAdjustProgress.bind(this)} ref={(ref) => { this.progressContainer = ref }}>
            ...
            <div className="time-and-volume">
              ...
              <div className="volume-container">
                ...
                <div className="volume-wrapper">
                  <div className="progress-container" onClick={this.handleAdjustVolume.bind(this)} ref={ref => { this.volumeContainer = ref }}>
